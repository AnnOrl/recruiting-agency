...
const initCustomers = (app, customersRepository, customerRepresentativesRepository) => {
    app.get('/api/customers', passport_1.default.authenticationMiddleware, async function (req, res) {
        return utils_1.withSortAndPagination(req, res, customersRepository
            .createQueryBuilder('customers')
            .leftJoinAndSelect('customers.customerRepresentatives', 'customerRepresentatives'), { name: 'customers.name', direction: 'ASC' });
    });
